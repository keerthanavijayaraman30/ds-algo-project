Feature: Queue module page functionality
  ...
  Scenario: Locate the Queue module first link
  ...
  Scenario: Locate the Stack module second link
    Given Click the word Queue from dropdown Datastructures
  ...
  Scenario: Locate the Stack module third link
     Given Click the word Queue from dropdown Datastructures
  ...
  Scenario: Locate the Stack module fourth link
     Given Click the word Queue from dropdown Datastructures
